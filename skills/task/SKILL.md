---
name: task
description: Read and seed a SpecScore project's task board — list tasks, inspect a single task, create a new task in `planning`. Use whenever you need to read the board or add a fresh entry. Status transitions are out of scope for this MVP.
user-invocable: true
---
